...
class RapierBindingsImpl extends RapierBindings {
  ...
  @override
  Vector3 getColliderPosition(int world, int handle) => throw UnsupportedError('Stub');

  @override
  Quaternion getColliderRotation(int world, int handle) => throw UnsupportedError('Stub');

  @override
  double getColliderFriction(int world, int handle) => throw UnsupportedError('Stub');

  @override
  double getColliderRestitution(int world, int handle) => throw UnsupportedError('Stub');

  @override
  double getColliderDensity(int world, int handle) => throw UnsupportedError('Stub');
  ...
  @override
  void setColliderPosition(int world, int handle, double x, double y, double z) => throw UnsupportedError('Stub');
