...
@_silgen_name("rapier_create_collider") @discardableResult func rapier_create_collider(_ world: UnsafeMutableRawPointer?, _ body: UInt32, _ desc: UnsafePointer<ColliderDesc>?) -> UInt32
...
@_silgen_name("rapier_get_collider_position_x") @discardableResult func rapier_get_collider_position_x(_ world: UnsafeMutableRawPointer?, _ handle: UInt32) -> Float
@_silgen_name("rapier_get_collider_position_y") @discardableResult func rapier_get_collider_position_y(_ world: UnsafeMutableRawPointer?, _ handle: UInt32) -> Float
@_silgen_name("rapier_get_collider_position_z") @discardableResult func rapier_get_collider_position_z(_ world: UnsafeMutableRawPointer?, _ handle: UInt32) -> Float
@_silgen_name("rapier_get_collider_rotation_x") @discardableResult func rapier_get_collider_rotation_x(_ world: UnsafeMutableRawPointer?, _ handle: UInt32) -> Float
@_silgen_name("rapier_get_collider_rotation_y") @discardableResult func rapier_get_collider_rotation_y(_ world: UnsafeMutableRawPointer?, _ handle: UInt32) -> Float
@_silgen_name("rapier_get_collider_rotation_z") @discardableResult func rapier_get_collider_rotation_z(_ world: UnsafeMutableRawPointer?, _ handle: UInt32) -> Float
@_silgen_name("rapier_get_collider_rotation_w") @discardableResult func rapier_get_collider_rotation_w(_ world: UnsafeMutableRawPointer?, _ handle: UInt32) -> Float
@_silgen_name("rapier_get_collider_friction") @discardableResult func rapier_get_collider_friction(_ world: UnsafeMutableRawPointer?, _ handle: UInt32) -> Float
@_silgen_name("rapier_get_collider_restitution") @discardableResult func rapier_get_collider_restitution(_ world: UnsafeMutableRawPointer?, _ handle: UInt32) -> Float
@_silgen_name("rapier_get_collider_density") @discardableResult func rapier_get_collider_density(_ world: UnsafeMutableRawPointer?, _ handle: UInt32) -> Float
...
@_silgen_name("rapier_set_collider_position") func rapier_set_collider_position(_ world: UnsafeMutableRawPointer?, _ handle: UInt32, _ x: Float, _ y: Float, _ z: Float) -> Void
@_silgen_name("rapier_set_collider_rotation") func rapier_set_collider_rotation(_ world: UnsafeMutableRawPointer?, _ handle: UInt32, _ x: Float, _ y: Float, _ z: Float, _ w: Float) -> Void
...
public class RapierPhysicsPlugin: NSObject, FlutterPlugin {
  public static func register(with registrar: FlutterPluginRegistrar) {
    ...
    if (ProcessInfo.processInfo.environment["FORCE_RAPIER_KEEP_SYMBOLS"] != nil) {
        ...
        // --- Collider ---
        rapier_create_collider(dummyWorld, 0, nil)
        rapier_create_heightfield_collider(dummyWorld, 0, nil, 0, 0, 0, 0, 0)
        rapier_get_collider_position_x(dummyWorld, 0)
        rapier_get_collider_position_y(dummyWorld, 0)
        rapier_get_collider_position_z(dummyWorld, 0)
        rapier_get_collider_rotation_x(dummyWorld, 0)
        rapier_get_collider_rotation_y(dummyWorld, 0)
        rapier_get_collider_rotation_z(dummyWorld, 0)
        rapier_get_collider_rotation_w(dummyWorld, 0)
        rapier_get_collider_friction(dummyWorld, 0)
        rapier_get_collider_restitution(dummyWorld, 0)
        rapier_get_collider_density(dummyWorld, 0)
        ...
        rapier_set_collider_position(dummyWorld, 0, 0, 0, 0)
        rapier_set_collider_rotation(dummyWorld, 0, 0, 0, 0, 0)
